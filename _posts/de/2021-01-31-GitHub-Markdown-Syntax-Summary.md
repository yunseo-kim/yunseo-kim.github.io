...
### 2.1. Zeilenumbrüche, Absatztrennung
In Markdown wird ein einzelner Zeilenwechsel nicht als Zeilenumbruch erkannt.
~~~
Erster Satz.
Zweiter Satz.
Dritter Satz.
...
Ein Zeilenumbruch wird durch zwei oder mehr aufeinanderfolgende Leerzeichen am Ende einer Zeile erzeugt.
~~~
Erster Satz.  
Zweiter Satz.  
Dritter Satz.
...
Sie können auch relative Pfadlinks verwenden, die auf andere Dateien im Repository verweisen. Die Verwendung ist identisch mit der im Terminal.
```
[README](../README.md)
```
...
Um eine erledigte Aufgabe zu kennzeichnen, verwenden Sie \[x].
```
- [x] Finish my changes
...
Verwenden Sie mindestens drei - für eine korrekte Erkennung.
```
