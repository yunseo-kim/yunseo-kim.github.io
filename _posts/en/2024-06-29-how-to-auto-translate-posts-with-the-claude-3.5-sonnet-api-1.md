...
(Added 12024.10.31.) On October 22, 12024, Anthropic announced an upgraded version of Claude 3.5 Sonnet API ("claude-3-5-sonnet-20241022") and Claude 3.5 Haiku. However, due to the [issue described later](#preventing-laziness-20241031-halloween-patch), this blog is still using the original "claude-3-5-sonnet-20240620" API.
