...
> [While microorganisms can live several kilometers deep in the Earth's crust](https://youtu.be/VD6xJq8NguY?si=szgtuLkuk6rPJag3), it is certainly not possible in the form claimed by the Hollow Earth Theory. I also really enjoy Jules Verne's novel "Journey to the Center of the Earth" and the movie "Journey to the Center of the Earth," but creative works should be enjoyed as fiction, not taken seriously as fact.
{: .prompt-tip }
...
> - Python visualization code: [yunseo-kim/physics-visualization repository](https://github.com/yunseo-kim/physics-visualization/blob/main/src/shell_theorem.py)
