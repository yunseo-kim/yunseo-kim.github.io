...
## Prerrequisitos
- [Teoremas de adición trigonométrica](/posts/2024-07-17-trigonometric-addition-formulas)
...
### Derivación
Utilizamos los [teoremas de adición trigonométrica](/posts/2024-07-17-trigonometric-addition-formulas)
...
Sumando ($\ref{eqn:sin_add}$) y ($\ref{eqn:sin_dif}$), obtenemos
...
Restando ($\ref{eqn:sin_dif}$) de ($\ref{eqn:sin_add}$), obtenemos
...
Sumando ($\ref{eqn:cos_add}$) y ($\ref{eqn:cos_dif}$), obtenemos
...
Restando ($\ref{eqn:cos_dif}$) de ($\ref{eqn:cos_add}$), obtenemos
...
Sustituyendo estos en ($\ref{sin_product_to_sum}$), ($\ref{cos_product_to_dif}$), ($\ref{cos_product_to_sum}$), y ($\ref{sin_product_to_dif}$) respectivamente, obtenemos las siguientes fórmulas:
