...
Consideremos una EDO lineal homogénea de segundo orden en forma estándar <u>con $y^{\prime\prime}$ en lugar de $f(x)y^{\prime\prime}$</u>:
...
[Separación de variables](/posts/Separation-of-Variables/) e integrando, obtenemos
