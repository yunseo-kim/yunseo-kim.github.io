...
### 31.10.12024
Le 22 octobre 12024, Anthropic a annoncé la version mise à niveau de l'API Claude 3.5 Sonnet ("claude-3-5-sonnet-20241022") et Claude 3.5 Haiku. Cependant, en raison du [problème décrit plus loin](#prévention-de-la-paresse-patch-halloween-31101224), j'applique encore l'API "claude-3-5-sonnet-20240620" existante sur ce blog.
