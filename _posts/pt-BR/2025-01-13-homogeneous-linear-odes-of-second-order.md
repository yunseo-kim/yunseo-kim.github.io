...
description: "Entenda a definição e características das EDOs lineares de segunda ordem, especialmente o princípio da superposição e o conceito de base que se aplicam às equações homogêneas."
...
Uma equação diferencial ordinária (EDO) de segunda ordem é chamada **linear** se pode ser escrita na forma
...
[Separando as variáveis](/posts/Separation-of-Variables/) e integrando, temos
