---
title: Equações diferenciais ordinárias lineares homogêneas de segunda ordem com coeficientes constantes
description: Examinamos a forma da solução geral de equações diferenciais ordinárias lineares homogêneas com coeficientes constantes, de acordo com o sinal do discriminante da equação característica.
...
Anteriormente, na [Equação de Bernoulli](/posts/Bernoulli-Equation/), encontramos a solução geral da equação logística, e de acordo com isso, a solução da equação diferencial ordinária linear de primeira ordem com coeficiente constante $k$:
