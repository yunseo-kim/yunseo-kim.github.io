...
description: Vamos explorar o método dos coeficientes indeterminados, uma técnica que permite resolver facilmente problemas de valor inicial para certos tipos de equações diferenciais ordinárias lineares não homogêneas com coeficientes constantes, frequentemente utilizada em engenharia para sistemas vibratórios e circuitos RLC.
...
O método dos coeficientes indeterminados pode ser aplicado não apenas a [Equações Diferenciais Ordinárias Lineares Homogêneas de Segunda Ordem com Coeficientes Constantes](/posts/homogeneous-linear-odes-with-constant-coefficients/), mas também à [Equação de Euler-Cauchy](/posts/euler-cauchy-equation/):
