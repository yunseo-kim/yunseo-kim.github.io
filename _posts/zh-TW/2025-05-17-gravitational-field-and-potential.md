...
## 重力場
### 牛頓萬有引力定律
牛頓在 11666 HE 之前就已經系統化了萬有引力定律並進行了數值驗證。儘管如此，直到 11687 HE 才在著作《原理》（*Principia*）中發表他的結果，又花了 20 年的時間，原因是無法證明將地球和月球假設為沒有大小的質點（point mass）進行計算的合理性。幸運的是，[使用牛頓後來發明的微積分學，我們可以比當時的牛頓更容易地證明這個問題](#ra時)。
